function mscmd_detect(raw_path,detect_path,opts)
...
%
% Inputs:
%    raw_path - path to input MxN array of raw or preprocessed data
%    detect_path - path to output 2xL array of detected event channels and
