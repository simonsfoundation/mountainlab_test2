...
cmd=sprintf('%s branch_cluster_v2 --raw=%s --detect=%s --adjacency_matrix=%s --firings_out=%s --clip_size=%d --min_shell_size=%d --shell_increment=%g --num_features=%d --detect_interval=%d',mscmd_exe,raw_path,detect_path,adjacency_matrix_path,out_firings_path,...
