...
cmd=sprintf('%s remove_noise_subclusters --raw=%s --firings=%s --firings_out=%s --clip_size=%d --detectability_threshold=%g --shell_increment=%g --min_shell_size=%d',mscmd_exe,...
