...
public:
    ...
    static QString mountainlabBasePath();
    static QString mlLogPath();
    static QString resolvePath(const QString& basepath, const QString& path);
    static void mkdirIfNeeded(const QString& path);
    static QString computeChecksumOfFile(const QString& path);
};
