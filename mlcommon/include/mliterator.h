...
public:
  ...
  counting_iterator() {}
  counting_iterator(T val) : m_value(val) {}
  counting_iterator(const counting_iterator &other) : m_value(other.m_value) {}
  ...
  counting_iterator operator--(int) { return counting_iterator(m_value--); }
  counting_iterator& operator++() { ++m_value; return *this; }
  counting_iterator& operator--() { --m_value; return *this; }
  counting_iterator& operator+=(difference_type dist) { m_value += dist; return *this; }
  counting_iterator& operator-=(difference_type dist) { m_value -= dist; return *this; }
