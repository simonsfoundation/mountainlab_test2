...
{
    if (name == "labels")
        return ui->labels->text();
    else if (name == "clipsize")
        return ui->clipsize->text().toInt();
    else if (name == "fixed_clipsize")
        return ui->fixed_clipsize->isChecked();
    else if (name == "save_to_disk")
        return ui->save_to_disk->isChecked();
    else
        return "";
}
