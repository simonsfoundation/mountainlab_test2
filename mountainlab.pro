...
#COMPONENTS = mdaconvert  mountainprocess mountainview mountainbrowser prv

isEmpty(COMPONENTS) {
    COMPONENTS = mdaconvert mountainprocess mountainsort mountainview mountaincompare prv
