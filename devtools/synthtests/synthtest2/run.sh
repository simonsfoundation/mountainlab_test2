...
mountainprocess run-process synthesize_timeseries_001_matlab --waveforms=waveforms.mda --timeseries=raw.mda --firings_true=firings_true.mda $opts | tee synthesize.log
